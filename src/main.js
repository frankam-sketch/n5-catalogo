...
export const CATALOGOS = [
  {
    ...
    label: 'N5 Concept',
    icon: '🔧',
    apiUrl: 'https://script.google.com/macros/s/TU_CODIGO/exec',
  },
  {
    id: 'n5-store',
    label: 'N5 Store',
    icon: '🛍️',
    apiUrl: 'https://script.google.com/macros/s/AKfycbypoOOD3gTl2AucQeKkhw5n91NqEfqSDaNWTK32249tzDKxlx4AoRTaVCh9_f3PfFQ/exec',
  },
  {
    id: 'n5-supply',
    label: 'N5 Supply',
